...
const AdminPending = () => {
    ...
    const fetchFilmsToDiscuss = async () => {
        try {
            const response = await fetch(`${API_URL_FRONTEND}/admin/films/pending`, { credentials: 'include' });
    ...
    const confirmDecision = async () => {
        ...
        try {
            const response = await fetch(`API_URL_FRONTEND/admin/films/${filmId}/status`, {
