...
const AdminAllFilms = () => {
    ...
    const fetchAllFilms = async () => {
        try {
            const response = await fetch(`${VITE_API_URL_FRONTEND}/admin/films`, { credentials: 'include' });
                    ...
                    <table className="w-full text-left border-collapse">
                        ...
                        <tbody className="divide-y divide-gray-50">
                            {loading ? [...Array(5)].map((_, i) => (
                                ...
                                const poster = rawPoster ? (rawPoster.startsWith('http') ? rawPoster : `${VITE_API_URL_FRONTEND}${rawPoster}`) : "/src/assets/youtube.png";
