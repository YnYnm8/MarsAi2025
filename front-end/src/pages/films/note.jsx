  ...
  useEffect(() => {
    const fetchFilmAndPlaylists = async () => {
      try {
        ...
        // 3️⃣ Ajouter le status basé sur PlaylistFilms et la vraie playlist
        ...
        // 3️⃣b️⃣ Compter le nombre de films dans chaque playlist
            ...
            <div className="flex justify-between text-xs font-semibold text-gray-500">
              {playlist.map((p) => (
                <button
                  ...
                  className={`flex flex-col items-center gap-1 hover:text-blue-600 ${filter === p.status ? "text-blue-600 font-bold" : ""
                    }`}
                >
                  <span>{p.status} {p.filmCount}</span>
                </button>
              ))}
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow p-4 flex flex-col md:flex-row justify-between items-center gap-6 mt-4">
            ...
            <div className="flex flex-col md:flex-row gap-2 w-full md:w-auto mt-2 md:mt-0">
              ...
              <button
                ...
                className="bg-gray-900 text-white rounded-lg px-6 py-2 text-sm font-semibold w-full md:w-auto"
              >
