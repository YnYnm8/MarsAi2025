...
export async function seedAll() {
    try {
        ...
        const films = await Film.bulkCreate([
            ...
            // --- 20 NOUVEAUX FILMS ---
            {
                UserId: 3, title: 'Neon Echoes', duration: 12, status: 'published', description: 'Une exploration visuelle des néons cyberpunk générée par IA.', generateAi: 'fullAi', collaborateur: 'Sora',
            ...
            {
                UserId: 1, title: 'Synthetic Horizon', duration: 8, status: 'approved', description: 'Le dernier jour sur Terre vu par une machine.', generateAi: 'fullAi', collaborateur: 'Runway AI',
            ...
            {
                UserId: 4, title: 'The Quantum Paradox', duration: 45, status: 'published', description: 'Voyage à travers les dimensions.', generateAi: 'fullAi', collaborateur: 'DALL-E 3',
            ...
            {
                UserId: 1, title: 'Silent Cosmos', duration: 15, status: 'published', description: 'Documentaire fictionnel sur le silence spatial.', generateAi: 'fullAi', collaborateur: 'ElevenLabs',
            ...
            {
                UserId: 3, title: 'Cybernetic Soul', duration: 22, status: 'approved', description: 'Action et philosophie dans un monde connecté.', generateAi: 'hybrid', collaborateur: 'VFX AI',
            ...
            {
                UserId: 2, title: 'Desert Rose', duration: 5, status: 'published', description: 'Évolution accélérée d\'une fleur numérique.', generateAi: 'fullAi', collaborateur: 'None',
            ...
            {
                UserId: 4, title: 'Binary Sunset', duration: 18, status: 'selected', description: 'La poésie des algorithmes.', generateAi: 'fullAi', collaborateur: 'ChatGPT',
            ...
            {
                UserId: 1, title: 'Flesh and Pixels', duration: 30, status: 'published', description: 'Où s\'arrête l\'homme et commence l\'ordinateur ?', generateAi: 'hybrid', collaborateur: 'John Smith',
            ...
            {
                UserId: 3, title: 'Digital Eden', duration: 10, status: 'published', description: 'La nature recréée par des réseaux de neurones.', generateAi: 'fullAi', collaborateur: 'None',
            ...
            {
                UserId: 2, title: 'Chronos', duration: 14, status: 'approved', description: 'Une manipulation temporelle visuelle.', generateAi: 'fullAi', collaborateur: 'AI Labs',
            ...
            {
                UserId: 4, title: 'Metropolis 2.0', duration: 60, status: 'published', description: 'Remake partiel du classique en IA.', generateAi: 'hybrid', collaborateur: 'CineAI',
            ...
            {
                UserId: 1, title: 'Ghosts of the Machine', duration: 9, status: 'selected', description: 'Des anomalies dans les réseaux de neurones.', generateAi: 'fullAi', collaborateur: 'Glitch Artist',
            ...
            {
                UserId: 3, title: 'The Last Algorithm', duration: 11, status: 'published', description: 'Le code qui a détruit internet.', generateAi: 'fullAi', collaborateur: 'Claude 3',
            ...
            {
                UserId: 2, title: 'Shadows of Tomorrow', duration: 35, status: 'approved', description: 'Film noir futuriste.', generateAi: 'hybrid', collaborateur: 'NoirStudios',
            ...
            {
                UserId: 4, title: 'Pixel Perfect', duration: 7, status: 'published', description: 'Animation abstraite et mathématique.', generateAi: 'fullAi', collaborateur: 'None',
            ...
            {
                UserId: 1, title: 'Memories of Mars', duration: 40, status: 'published', description: 'Une colonie imaginaire vue de l\'intérieur.', generateAi: 'fullAi', collaborateur: 'Mars.A.I Team',
            ...
            {
                UserId: 2, title: 'Symphony in Code', duration: 21, status: 'published', description: 'Un orchestre virtuel joue une partition générée.', generateAi: 'fullAi', collaborateur: 'Suno AI',
