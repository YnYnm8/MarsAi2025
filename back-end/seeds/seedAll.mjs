...
export async function seedAll() {
    try {
        ...
        const films = await Film.bulkCreate([
            ...
            // --- 20 NOUVEAUX FILMS ---
            {
                UserId: 3, title: 'Neon Echoes', duration: 12, status: 'submitted', description: 'Une exploration visuelle des néons cyberpunk générée par IA.', generateAi: 'fullAi', collaborateur: 'Sora',
            ...
            {
                UserId: 1, title: 'Synthetic Horizon', duration: 8, status: 'submitted', description: 'Le dernier jour sur Terre vu par une machine.', generateAi: 'fullAi', collaborateur: 'Runway AI', 
            ...
            {
                UserId: 2, title: 'Human After All', duration: 25, status: 'submitted', description: 'Un androïde cherche à comprendre les émotions humaines.', generateAi: 'hybrid', collaborateur: 'Studio A', 
            ...
            {
                UserId: 4, title: 'The Quantum Paradox', duration: 45, status: 'submitted', description: 'Voyage à travers les dimensions.', generateAi: 'fullAi', collaborateur: 'DALL-E 3', 
            ...
            {
                UserId: 1, title: 'Silent Cosmos', duration: 15, status: 'submitted', description: 'Documentaire fictionnel sur le silence spatial.', generateAi: 'fullAi', collaborateur: 'ElevenLabs',
            ...
            {
                UserId: 3, title: 'Cybernetic Soul', duration: 22, status: 'submitted', description: 'Action et philosophie dans un monde connecté.', generateAi: 'hybrid', collaborateur: 'VFX AI',
            ...
            {
                UserId: 2, title: 'Desert Rose', duration: 5, status: 'submitted', description: 'Évolution accélérée d\'une fleur numérique.', generateAi: 'fullAi', collaborateur: 'None',
            ...
            {
                UserId: 4, title: 'Binary Sunset', duration: 18, status: 'submitted', description: 'La poésie des algorithmes.', generateAi: 'fullAi', collaborateur: 'ChatGPT',
            ...
            {
                UserId: 1, title: 'Flesh and Pixels', duration: 30, status: 'submitted', description: 'Où s\'arrête l\'homme et commence l\'ordinateur ?', generateAi: 'hybrid', collaborateur: 'John Smith',
            ...
            {
                UserId: 3, title: 'Digital Eden', duration: 10, status: 'submitted', description: 'La nature recréée par des réseaux de neurones.', generateAi: 'fullAi', collaborateur: 'None',
            ...
            {
                UserId: 2, title: 'Chronos', duration: 14, status: 'submitted', description: 'Une manipulation temporelle visuelle.', generateAi: 'fullAi', collaborateur: 'AI Labs',
            ...
            {
                UserId: 4, title: 'Metropolis 2.0', duration: 60, status: 'submitted', description: 'Remake partiel du classique en IA.', generateAi: 'hybrid', collaborateur: 'CineAI',
            ...
            {
                UserId: 1, title: 'Ghosts of the Machine', duration: 9, status: 'submitted', description: 'Des anomalies dans les réseaux de neurones.', generateAi: 'fullAi', collaborateur: 'Glitch Artist', shares: "140", views: "1000",
            ...
            {
                UserId: 3, title: 'The Last Algorithm', duration: 11, status: 'submitted', description: 'Le code qui a détruit internet.', generateAi: 'fullAi', collaborateur: 'Claude 3',
            ...
            {
                UserId: 2, title: 'Shadows of Tomorrow', duration: 35, status: 'submitted', description: 'Film noir futuriste.', generateAi: 'hybrid', collaborateur: 'NoirStudios',
            ...
            {
                UserId: 4, title: 'Pixel Perfect', duration: 7, status: 'submitted', description: 'Animation abstraite et mathématique.', generateAi: 'fullAi', collaborateur: 'None',
            ...
            {
                UserId: 1, title: 'Memories of Mars', duration: 40, status: 'submitted', description: 'Une colonie imaginaire vue de l\'intérieur.', generateAi: 'fullAi', collaborateur: 'Mars.A.I Team',
            ...
            {
                UserId: 3, title: 'Deep Fake Love', duration: 16, status: 'submitted', description: 'Comédie romantique entre deux IA.', generateAi: 'hybrid', collaborateur: 'Actors Guild',
            ...
            {
                UserId: 2, title: 'Symphony in Code', duration: 21, status: 'submitted', description: 'Un orchestre virtuel joue une partition générée.', generateAi: 'fullAi', collaborateur: 'Suno AI',
                Files: [{ subtitle: 'None', film_url: sampleVideo, poster_url: 'https://picsum.photos/seed/film19/800/1200', outil_Ai: 'Suno + Pika', creativeMethodology: 'Musique IA synchronisée avec vidéo.' }]
            },
            {
            ...
            {
                UserId: 4, title: 'The Architect', duration: 55, status: 'submitted', description: 'Création d\'un monde de A à Z.', generateAi: 'fullAi', collaborateur: 'Visionary',
